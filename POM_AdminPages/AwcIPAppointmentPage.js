...
class AwcIPAppointmentPage {
    ...
    constructor(page) {
        ...
        this.selectAwcIPModule = page.locator("//div[text()='AWC In-patient']/../..");
    ...
    async navigateToAppointmentModule() {
        ...
        await this.page.waitForTimeout(1000);
        await this.selectAwcIPModule.click();
        await this.page.waitForTimeout(2000);
        await this.page.locator("[class='appointment-name']").hover();
...
module.exports = { AwcIPAppointmentPage };