...
class InPatientAppointmentPage {
    ...
    constructor(page) {
        ...
        this.selectIPModule = page.locator("//div[text()='In-patient']/../..");
    ...
    async navigateToAppointmentModule() {
        ...
        await this.page.waitForTimeout(1000);
        await this.selectIPModule.click();
        await this.page.waitForTimeout(2000);
...
module.exports = { InPatientAppointmentPage };