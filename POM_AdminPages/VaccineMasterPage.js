...
class VaccineMasterPage {
    constructor(page) {
        ...
        this.selectVaccineMaster = page.locator("//div[text()='Vaccine Master']/../..");

        //dashboard
        this.search = page.locator("#vaccinequickFilter");
        this.downloadBtn = page.locator("//button[@class='btn mr-2 btn-primary']");
        this.addVaccineBtn = page.locator("//button[@class='btn submitbtn-color w-auto mr-4 btn-secondary']");
        ...
        //Add vaccine Master
        this.vaccineName = page.locator("#vaccinename");
    ...
    async navigateToVaccineMaster() {
        await this.VaccineModule.hover();
        await this.page.waitForTimeout(2000);
        await this.selectVaccineorServiceModule.click();
        await this.page.waitForTimeout(1000);
        await this.selectVaccineMaster.click();
    }


    async clickAddVaccineBtn() {
        await this.addVaccineBtn.click();
        await this.page.waitForTimeout(2000);


    }

    async addVaccineMaster(vaccineName, targetDisease, description) {
    ...
    async clickViewBtn(givenVaccineName) {
        await this.page.waitForTimeout(1000);
        await this.page.locator(`//div[text()='${givenVaccineName}']/following-sibling::div[@col-id='action']//button[@class='btn view-btn btn-secondary']`).click();

    }


    async clickDeleteBtn(givenVaccineName) {
        await this.page.waitForTimeout(1000);
        await this.page.locator(`//div[text()='${givenVaccineName}']/following-sibling::div[@col-id='action']//button[@class='btn delete-btn btn-secondary']`).click();


    }

    async clickEditBtn(givenVaccineName) {
        await this.page.waitForTimeout(1000);
        await this.page.locator(`//div[text()='${givenVaccineName}']/following-sibling::div[@col-id='action']//button[@class='btn edit-btn btn-secondary']`).click();
...
module.exports = { VaccineMasterPage };
