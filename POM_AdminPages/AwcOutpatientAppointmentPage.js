...
class AwcOPAppointmentPage {
    ...
    constructor(page) {
        ...
        this.selectAwcOpModule = page.locator("//div[text()='AWC Outpatient']/../..");
    ...
    async navigateToAppointmentModule() {
        ...
        await this.page.waitForTimeout(1000);
        await this.selectAwcOpModule.click();
        await this.page.waitForTimeout(2000);
...
module.exports = { AwcOPAppointmentPage };