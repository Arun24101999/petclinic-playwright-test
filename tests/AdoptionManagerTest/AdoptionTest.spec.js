...
test.describe('TS02 - Adoption Requests Module Tests', () => {
    ...
    test('TC002 - Select User Role', async () => {
        ...
        await usersPage.selectUserRoleOption('Adoption Manager');
    })
    ...
    test('TC012 - Select Foster Active', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
    ...
    test('TC013 - Select Trial Active', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
    ...
    test('TC014 - Select Adoption History Module', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
        await adoptionPage.navigateToAdoptionHistory();
    })

    test('TC015 - Select Adoption History', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
    ...
    test('TC016 - Select Foster History', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
    ...
    test('TC017 - Select Trial History', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
    ...
    test('TC018 - Select Return History', async () => {
        const adoptionPage = new AdoptionPage(page);
        await page.waitForTimeout(1000);
